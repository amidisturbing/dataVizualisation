...
The plot shows that there were more than 15000 dogs, about 3500 cats, a few bats, raccoons and some other animals in the Top 5.
...
```{r fig.cap="Visualizing the dog breeds of the animal bite dataset we clearly see, that pit bulls are on the very top of the ranking. It is important to keep in mind that serious bites are more likely to be reported.", dogBitesPerBreed}
```
